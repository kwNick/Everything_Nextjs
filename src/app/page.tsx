...
export default function Home() {
  return (
    <div className="w-full min-h-screen flex flex-col items-center">
      ...
      <section className="h-[100vh] w-3/5 flex items-center justify-center">
        <h1>HomePage!</h1>
      </section>

      <section className="h-[100vh] w-3/5 flex items-center gap-x-10">
        ...
        <Image src={windows} alt={'windows'} width={200} height={250} className='' />
      </section>
      ...
      <section className="h-[100vh] w-3/5 flex items-center gap-x-10">
        ...
        <Image src={oranges} alt={'fruit'} width={200} height={250} className='' />
      </section>
    </div>
  );
}
